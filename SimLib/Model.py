...
class Model():
    ...
    def __init__(self, physics, phobject, time = 0, dt_max = .01):
        self.dt_max = dt_max
        self.physics = physics
        self.phobject = phobject
        self.time = time
    ...
    def advance(self, dt):
        ...
        self.time, self.phobject = self.physics.advance(self.time, 
                                                         self.phobject, 
                                                               dt)
...
class NBodyModel(Model):
    ...
    def __init__(self, phob_list, dt_max = .01):
        self.dt_max = dt_max
        self.phobjects = phos.Phobjects(phob_list)
        rk4 = slv.RK4()
        physics = phys.NBody(rk4, self.dt_max)
        
        super().__init__(physics, self.phobjects.phobject_mat, 0, dt_max)
